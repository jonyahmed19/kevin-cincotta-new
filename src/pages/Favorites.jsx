...
const Links = () => (
  <ul className="linkList">
    <li>
      <Link to="/shop/paintings">Painting</Link>
    </li>
    <li>
      <Link to="/shop/smallprints">Small Print</Link>
    </li>
    <li>
      <Link to="/shop/largeprints">Large Print</Link>
    </li>
    <li>
      <Link to="/shop/canvasprints">Canvas Print</Link>
    </li>
  </ul>
);
...
const info = () => (
  <div className="series">
    <p>Add more favorites by browsing any of these lists:</p>
    <Links />
    <p>
      When viewing any painting, click <i className="fa-thin fa-heart" /> to
      favorite or unfavorite by clicking <i className="fa-solid fa-heart" />.
    </p>
  </div>
);
...
function Favorites(props) {
  ...
  return (
    <Series {...props} images={myFaves} series="Favorites" footer={info} />
  );
}
